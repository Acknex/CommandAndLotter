...
void topdown_camera_update() 
{
	...
	//	topdown_camera_set_pos(nullvector);
        ...
        topdown_camera_centerTarget.x = clamp(topdown_camera_centerTarget.x, -8000, 8000);
        topdown_camera_centerTarget.y = clamp(topdown_camera_centerTarget.y, -8000, 8000);
